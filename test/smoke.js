...
ipcMain.handle('get-config', () => ({
  palette: 'nna', layout: 'bars', compact: false, opacity: 0.95, width: 260,
...
const FAKE = {
  ...
  config: { palette: 'nna', layout: 'bars', opacity: 0.35, hoverBoost: true, showContext: true, showForecast: true },
}
