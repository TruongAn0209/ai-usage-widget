...
for APP in "dist/mac/Claude Usage Widget.app" "dist/mac-arm64/Claude Usage Widget.app"; do
...
for APP_DIR in dist/mac dist/mac-arm64; do
  [ -d "$APP_DIR" ] || continue
  ASAR="$APP_DIR/Claude Usage Widget.app/Contents/Resources/app.asar"
...
NOTES="dist/RELEASE_NOTES.txt"
{
  ...
  echo "  2. Kéo 'Claude Usage Widget.app' vào Applications (thả đúng vào cửa sổ Applications hiện"
  ...
  echo "     xattr -cr \"/Applications/Claude Usage Widget.app\""
  echo
